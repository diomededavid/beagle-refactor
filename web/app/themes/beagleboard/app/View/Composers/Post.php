<?php
    ...
    class TemplateBoardSelection extends Composer
    {
        protected static $views = [
            'template-board-selection', // Update to match your Blade view name
        ];
        ...
        protected function beagleSelection(): WP_Query
        {
            $args = [
                ...
                'posts_per_page' => -1,
                'post_status'    => 'publish',
                'category__and'  => [CATEGORY_PARENT_ID_BOARDS, CATEGORY_BEAGLES],
                'meta_key'       => '_thumbnail_id',
                'orderby'        => 'publish_date',
                'order'          => 'DESC',
            ];
        ...
        protected function riscVSelection(): WP_Query
        {
            $args = [
                ...
                'posts_per_page' => -1,
                'post_status'    => 'publish',
                'category__and'  => [CATEGORY_PARENT_ID_BOARDS, CATEGORY_RISCV],
                'meta_key'       => '_thumbnail_id',
                'orderby'        => 'publish_date',
                'order'          => 'DESC',
            ];
        ...
        protected function compatibleBoardSelection(): WP_Query
        {
            $args = [
                ...
                'posts_per_page' => -1,
                'post_status'    => 'publish',
                'category__and'  => [CATEGORY_PARENT_ID_BOARDS, CATEGORY_COMPATIBLE],
                'meta_key'       => '_thumbnail_id',
                'orderby'        => 'publish_date',
                'order'          => 'DESC',
            ];
